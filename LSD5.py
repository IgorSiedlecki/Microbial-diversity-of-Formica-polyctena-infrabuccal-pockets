...
print("This is L(ibrary)S(ingle)D(enoise) 2.0 script created by Michał Kolasa in Symbiosis Evolution Research Group®)")
...
if question == "I have it all in my pinky finger!":
    ...
    Next, it converts fastq to fasta file, dereplicate, and denoise sequences in each library separately.\n
    ...
    You might want to leave the planet, so here's a quick guide:\n

    1. Phone NASA. Their phone number is (713) 483-3111.\n Explain that it’s very important that you get away as soon as possible.\n
    2. If they do not cooperate, phone any friend you may have in the White House:(202) 456-1414\n to have a word on your behalf with the guys at NASA.\n
    3. If you don’t have any friends in the White House, phone the Kremlin (ask the overseas operator for 0107-095-295-9051).\n They don’t have any friends there either (at least, none to speak of),\n but they do seem to have a little influence, so you may as well try.\n
...
to your custom database':""", choices=["Mitochondrial", "Bacterial and 18S", "Fungal", "Custom"]).ask()


print("Joining R1 and R2 files through Pear.....................\n ", end="")
...
if type_of_data == "Mitochondrial":
    ...
    db_path = "/mnt/qnap/users/symbio/software/databases/sh_general_release_dynamic_all_04.04.2024_I2.fasta"
